...
function deuRuim(p1, t1) {
    if (p1 == "pipoca" && t1 == tP * 2 || p1 == "carne" && t1 == tC * 2 ||
        p1 == "macarrao" && t1 == tM * 2 || p1 == "feijao" && t1 == tF * 2 ||
        p1 == "brigadeiro" && t1 == tB * 2) {
        console.log(`A comida queimou. Prato pronto, bom apetite!!`)

    } else if (p1 == "pipoca" && t1 >= tP * 3 || p1 == "carne" && t1 >= tC * 3 ||
        p1 == "macarrao" && t1 >= tM * 3 || p1 == "feijao" && t1 >= tF * 3 ||
        p1 == "brigadeiro" && t1 >= tB * 3) {
        console.log("Kabummm, Prato pronto, bom apetite!!");

    } else {
        console.log("Passou da conta patrão, Prato pronto, bom apetite!!!");
